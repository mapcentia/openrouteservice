        ...
        return (
            <div className="tab-pane pull-right hide-print" id="">
              {/*   <div className="badge" style={style} onClick={this.handeClick} ><i className="fa fa-palette" aria-hidden="true"></i> Vælg farve</div>
                ...
                <button className="btn btn-default btn-raised btn-xs" style={style} onClick={this.props.toggle} alt="Vis/Skjul - Aktuelt opland"><i className="fa fa-eye" aria-hidden="true"></i> Vis/Skjul - Aktuelt opland</button>
