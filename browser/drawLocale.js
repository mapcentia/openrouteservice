...
module.exports = {
    ...
    setDHPLanguage: function(utils){
        this.draw.toolbar.buttons.polygon = utils.__("Draw catchment", this.dict);
        this.draw.toolbar.buttons.marker = utils.__("Place retail", this.dict);
    },
